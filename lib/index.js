...
function stackValueToList(value) {
  ...
  while (value.contents.length != 0) {
    ...
    value = value.get(0); // TODO last value never gets into values
  }
  return values;
}
...
if (process.env.NODE_ENV === "test") {
  module.exports._arbClient = _arbClient;
  module.exports.EVM_REVERT_CODE = EVM_REVERT_CODE;
  module.exports.EVM_INVALID_CODE = EVM_INVALID_CODE;
  module.exports.EVM_RETURN_CODE = EVM_RETURN_CODE;
  module.exports.EVM_STOP_CODE = EVM_STOP_CODE
  module.exports.EVM_BAD_SEQUENCE_CODE = EVM_BAD_SEQUENCE_CODE;
  module.exports.logValToLog = logValToLog;
  module.exports.stackValueToList = stackValueToList;
  module.exports.processMessage = processMessage;
  module.exports.processLog = processLog;
  module.exports.ArbClient = ArbClient;
  module.exports.ArbWallet = ArbWallet;
}
